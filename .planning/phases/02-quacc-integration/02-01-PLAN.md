...
must_haves:
  truths:
    ...
    - "Cluster config persists to JSON file"
...
- Handle ImportError gracefully (skip modules with missing optional deps like MLIP)
- Log skipped modules at DEBUG level
...
- All imports succeed even when quacc is not installed
  </done>
</task>
...
- `test_discover_skips_import_errors` - Mock module with ImportError, verify graceful skip
